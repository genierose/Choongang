...
CREATE TABLE BUYER (
	...
	buyer_address VARCHAR2(255) NOT NULL, /* 구매자 집주소 */
...
CREATE TABLE PRODUCT (
	...
	product_company VARCHAR2(255) NOT NULL, /* 상품 제조회사 */
	product_image VARCHAR2(255) NOT NULL, /* 상품 이미지 */
	product_content VARCHAR2(255) NOT NULL, /* 상품 설명 */
...
/* 공지사항 */
CREATE TABLE NOTICE (
	notice_index INT NOT NULL, /* 공지 번호 */
	notice_title VARCHAR2(255) NOT NULL, /* 공지 제목 */
	notice_content VARCHAR2(255) NOT NULL, /* 공지 내용 */
	notice_image VARCHAR2(255) NOT NULL, /* 공지 이미지 */
...
CREATE TABLE SELLER (
	...
	seller_address VARCHAR2(255) NOT NULL, /* 판매자 주소 */
	seller_email VARCHAR2(40) NOT NULL, /* 판매자 이메일 */
	seller_phone VARCHAR2(30) NOT NULL, /* 판매자 전화번호 */
	seller_business VARCHAR2(255) NOT NULL, /* 판매자 업종 */
...
CREATE TABLE REVIEW (
	...
	product_idx INT NOT NULL, /* 상품 번호 */
	buyer_idx INT NOT NULL, /* 구매자 번호 */
	review_content VARCHAR2(255) NOT NULL, /* 후기 글내용 */
...
CREATE TABLE AUCTION (
	...
	seller_name VARCHAR2(50) NOT NULL, /* 판매자 이름 */
	seller_phone VARCHAR2(30) NOT NULL, /* 판매자 전화번호 */
	auction_content VARCHAR2(255) NOT NULL, /* 경매 내용 */
...
/* 주문 */
CREATE TABLE ORDERS (
	order_idx INT NOT NULL, /* 주문 고유번호 */
	order_date DATE NOT NULL, /* 주문 날짜 */
	order_cancel VARCHAR2(255) NOT NULL, /* 주문 취소여부 */
	product_idx INT NOT NULL, /* 상품 번호 */
	...
	order_recname VARCHAR2(50) NOT NULL, /* 수령자 이름 */
	order_recaddress VARCHAR2(255) NOT NULL, /* 수령자 우편번호 */
	order_recphone VARCHAR2(30) NOT NULL /* 수령자 전화번호 */
);
...
CREATE TABLE FAQ (
	...
	faq_content VARCHAR2(255) NOT NULL, /* FAQ 내용 */
	faq_answer VARCHAR2(255) /* FAQ 답변 */
);
...
CREATE TABLE QNA (
	...
	buyer_idx INT NOT NULL, /* 구매자 번호 */
	qna_question VARCHAR2(255) NOT NULL, /* QNA 질문 */
	qna_answer VARCHAR2(255), /* QNA 답변 */
...
CREATE TABLE AD (
	...
	ad_image VARCHAR2(255) NOT NULL /* 광고 이미지 */
);
